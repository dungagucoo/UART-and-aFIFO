...
HD_PWD='D:/Vivado/Bao cao/do an 2/async_fifo_2020.2/async_fifo_2020.2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log csv_afifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source csv_afifo.tcl
