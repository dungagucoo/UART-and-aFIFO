...
HD_PWD='D:/Vivado/_Bai_tap/CSTT/UART_rutgon_2020_2/UART_rutgon_2020_2.runs/design_1_connect_UART_RX_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_connect_UART_RX_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_connect_UART_RX_0_0.tcl
